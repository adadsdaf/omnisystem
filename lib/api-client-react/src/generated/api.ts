...
export const getGetPrinterSettingsUrl = () => {




  return `/api/printer-settings`
}

/**
 * @summary Get printer layout settings
 */
export const getPrinterSettings = async ( options?: RequestInit): Promise<PrinterSettings> => {

  return customFetch<PrinterSettings>(getGetPrinterSettingsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetPrinterSettingsQueryKey = () => {
    return [
...
export const getGetPrinterSettingsQueryOptions = <TData = Awaited<ReturnType<typeof getPrinterSettings>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPrinterSettings>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetPrinterSettingsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPrinterSettings>>> = ({ signal }) => getPrinterSettings({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPrinterSettings>>, TError, TData> & { queryKey: QueryKey }
}

export type GetPrinterSettingsQueryResult = NonNullable<Awaited<ReturnType<typeof getPrinterSettings>>>
export type GetPrinterSettingsQueryError = ErrorType<unknown>
...
export function useGetPrinterSettings<TData = Awaited<ReturnType<typeof getPrinterSettings>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPrinterSettings>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetPrinterSettingsQueryOptions(options)
...
export const getUpdatePrinterSettingsUrl = () => {
...
/**
 * @summary Update printer layout settings
 */
export const updatePrinterSettings = async (printerSettingsInput: PrinterSettingsInput, options?: RequestInit): Promise<PrinterSettings> => {

  return customFetch<PrinterSettings>(getUpdatePrinterSettingsUrl(),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(printerSettingsInput)
  }
);}
...
export const getUpdatePrinterSettingsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePrinterSettings>>, TError,{data: BodyType<PrinterSettingsInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePrinterSettings>>, TError,{data: BodyType<PrinterSettingsInput>}, TContext> => {

const mutationKey = ['updatePrinterSettings'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePrinterSettings>>, {data: BodyType<PrinterSettingsInput>}> = (props) => {
          const {data} = props ?? {};

          return  updatePrinterSettings(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePrinterSettingsMutationResult = NonNullable<Awaited<ReturnType<typeof updatePrinterSettings>>>
    export type UpdatePrinterSettingsMutationBody = BodyType<PrinterSettingsInput>
    export type UpdatePrinterSettingsMutationError = ErrorType<unknown>

    /**
 * @summary Update printer layout settings
 */
export const useUpdatePrinterSettings = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePrinterSettings>>, TError,{data: BodyType<PrinterSettingsInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updatePrinterSettings>>,
        TError,
        {data: BodyType<PrinterSettingsInput>},
        TContext
      > => {
      return useMutation(getUpdatePrinterSettingsMutationOptions(options));
    }

export const getGetPrintersListUrl = () => {




  return `/api/printers/list`
}

/**
 * @summary List available system printers
 */
export const getPrintersList = async ( options?: RequestInit): Promise<string[]> => {

  return customFetch<string[]>(getGetPrintersListUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetPrintersListQueryKey = () => {
    return [
    `/api/printers/list`
    ] as const;
    }
...
export const getGetPrintersListQueryOptions = <TData = Awaited<ReturnType<typeof getPrintersList>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPrintersList>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetPrintersListQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPrintersList>>> = ({ signal }) => getPrintersList({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPrintersList>>, TError, TData> & { queryKey: QueryKey }
}

export type GetPrintersListQueryResult = NonNullable<Awaited<ReturnType<typeof getPrintersList>>>
export type GetPrintersListQueryError = ErrorType<unknown>
...
export function useGetPrintersList<TData = Awaited<ReturnType<typeof getPrintersList>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPrintersList>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetPrintersListQueryOptions(options)
...
export const getPrintReceiptDirectUrl = () => {




  return `/api/printers/print`
}

/**
 * @summary Print receipt directly to a named printer
 */
export const printReceiptDirect = async (directPrintInput: DirectPrintInput, options?: RequestInit): Promise<PrintReceiptDirect200> => {

  return customFetch<PrintReceiptDirect200>(getPrintReceiptDirectUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(directPrintInput)
  }
);}
...
export const getPrintReceiptDirectMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof printReceiptDirect>>, TError,{data: BodyType<DirectPrintInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof printReceiptDirect>>, TError,{data: BodyType<DirectPrintInput>}, TContext> => {

const mutationKey = ['printReceiptDirect'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof printReceiptDirect>>, {data: BodyType<DirectPrintInput>}> = (props) => {
          const {data} = props ?? {};

          return  printReceiptDirect(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PrintReceiptDirectMutationResult = NonNullable<Awaited<ReturnType<typeof printReceiptDirect>>>
    export type PrintReceiptDirectMutationBody = BodyType<DirectPrintInput>
    export type PrintReceiptDirectMutationError = ErrorType<unknown>

    /**
 * @summary Print receipt directly to a named printer
 */
export const usePrintReceiptDirect = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof printReceiptDirect>>, TError,{data: BodyType<DirectPrintInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof printReceiptDirect>>,
        TError,
        {data: BodyType<DirectPrintInput>},
        TContext
      > => {
      return useMutation(getPrintReceiptDirectMutationOptions(options));
    }
