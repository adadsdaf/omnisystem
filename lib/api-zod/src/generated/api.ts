 ...
 */
export const GetPrinterSettingsResponse = zod.object({
  "paperWidth": zod.number(),
  "leftMargin": zod.number(),
  "rightMargin": zod.number(),
  "topMargin": zod.number(),
  "bottomMargin": zod.number(),
  "fontSize": zod.number(),
  "lineSpacing": zod.number(),
  "charactersPerLine": zod.number()
})
 ...
 */
export const UpdatePrinterSettingsBody = zod.object({
  "paperWidth": zod.number().optional(),
  "leftMargin": zod.number().optional(),
  "rightMargin": zod.number().optional(),
  "topMargin": zod.number().optional(),
  "bottomMargin": zod.number().optional(),
  "fontSize": zod.number().optional(),
  "lineSpacing": zod.number().optional(),
  "charactersPerLine": zod.number().optional()
})

export const UpdatePrinterSettingsResponse = zod.object({
  "paperWidth": zod.number(),
  "leftMargin": zod.number(),
  "rightMargin": zod.number(),
  "topMargin": zod.number(),
 ...
 */
export const GetPrintersListResponseItem = zod.string()
export const GetPrintersListResponse = zod.array(GetPrintersListResponseItem)


/**
 * @summary Print receipt directly to a named printer
 */
export const PrintReceiptDirectBody = zod.object({
  "printerName": zod.string().nullish(),
  "content": zod.string(),
  "copies": zod.number().optional()
})

export const PrintReceiptDirectResponse = zod.object({
  "ok": zod.boolean(),
